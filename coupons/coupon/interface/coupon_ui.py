# coupons/coupon/interface/coupon_ui.py  (añade imports si faltan)
from flask import Blueprint, render_template, redirect, url_for, flash, jsonify
from flask_login import login_required, current_user
from app.models import Negocio, Producto, ProductoDetalle, Tamanio, Color
...
def products_json():
    ...
    if not negocio:
        return jsonify([]), 200
    qs = Producto.query.filter_by(id_negocio=negocio.id).order_by(Producto.nombre.asc()).all()
